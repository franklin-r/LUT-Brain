...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4041090
SOPC_SYSID_FLAG += --sidp=0x4041090
ELF_PATCH_FLAG  += --sidp 0x4041090

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1587448445
SOPC_SYSID_FLAG += --timestamp=1587448445
ELF_PATCH_FLAG  += --timestamp 1587448445
